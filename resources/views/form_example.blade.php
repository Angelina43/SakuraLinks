...
<div class="body">
    <header>
        ...
        <div class="firstForm">
            <form>
                <input class="input" placeholder="Вставьте сюда ссылку">
                ...
                <input class="input second" placeholder="Напишите новый URL" id="input">
                <input class="button" type="button" name="" id="" value="Обработать">
            </form>
        </div>
    <div class="secondForm">
        <div class="url">
            <p>Здесь типа ссылка</p>
            <img src="images/copy.png" alt="копировать" class="copy">
        </div>
        <input class="button" type="button" name="" id="" value="Вернуться к рефактору">
    </div>
